...
using namespace std;
const set<string> CodeWriter::arithCommands =
    {"add", "sub", "neg", "eq", "gt", "lt", "and", "or", "not"};
const unordered_map<string, string> CodeWriter::segmentMap =
    {{"local", "LCL"}, {"this", "THIS"}, {"that", "THAT"}, {"argument", "ARG"}};
const unordered_map<string, Segment> CodeWriter::segmentEnumMap = {
    {"local", Segment::LOCAL},
    {"this", Segment::THIS},
    {"that", Segment::THAT},
